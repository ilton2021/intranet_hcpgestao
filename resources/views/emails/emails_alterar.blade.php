						...
						<tr>
							...
							<td>
								<select class="form-control" id="unidade_id" name="unidade_id">
									...
									<?php
									$selected = '';
									if ($emails[0]->unidade_id == $unidade->id) {
										$selected = 'selected';
									}
									?>
									<option id="unidade_id" name="unidade_id" <?php echo $selected; ?> value="{{$unidade->id}}">{{ $unidade->nome }}</option>
									@endforeach
								</select>
							</td>
						</tr>
