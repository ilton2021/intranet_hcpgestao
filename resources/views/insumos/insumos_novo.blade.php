@extends('layouts.adm')
	...
	<div class="row" style="margin-top: 0px;">
		<div class="col-md-12 text-center">
			<h3 style="font-size: 18px;">CADASTRAR NOVO INSUMO:</h3>
		</div>
	</div>
	@if ($errors->any())
		 ...
		 <div class="accordion" id="accordionExample">
                <div class="card">
                    <a class="card-header bg-success text-decoration-none text-white bg-success" type="button" data-toggle="collapse" data-target="#PESSOAL" aria-expanded="true" aria-controls="PESSOAL">
                        Insumos: <i class="fas fa-check-circle"></i>
                    </a>
                </div>	
					<form action="{{\Request::route('storeInsumos', $id)}}" method="post">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<table border="0" class="table-sm" style="line-height: 1.5;" >
						 <tr>
							<td> Tipos de Insumo: </td>
							<td>
								<select class="form-control" style="width: 400px" id="tipos_insumos_id" name="tipos_insumos_id">
						 ...
						 <tr>
							<td><input hidden type="text" id="tela" name="tela" class="form-control" value="novo_insumos" /></td>
