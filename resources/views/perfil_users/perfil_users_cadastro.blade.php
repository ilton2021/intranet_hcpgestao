...
<div class="container-fluid">
	<div class="row" style="margin-bottom: 25px;">
		<div class="col-md-12 text-center">
			<h5  style="font-size: 18px;"><b>CADASTRO PERFIL DO USUÁRIO:</b></h5>
		</div>
	</div>	
	@if ($errors->any())
	...
	<div class="row">
		<div class="col-md-12">
			...
			<form action="{{ route('pesquisarPerfilUsuarios') }}" method="post">
				...
				<tr>
					...
					<td>
					  <p align="right">
						...
						<a class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('usuariosPerfilNovo')}}"> Novo <i class="fas fa-check"></i> </a>
					  </p>
					</td>
				</tr>
			</table>
			<table class="table table-sm " id="my_table">
				...
				<tbody>
					...
					<tr>
						<td style="font-size: 15px;">{{$perfil->nome}}</td>
						<td><center><a class="btn btn-info btn-sm" href="{{ route('usuariosPerfilAlterar', $perfil->id) }}" ><i class="fas fa-edit"></i></center></td>
                        <td><center><a class="btn btn-danger btn-sm" href="{{ route('usuariosPerfilExcluir', $perfil->id) }}" ><i class="fas fa-times-circle"></i></center></td>
					</tr>
					@endforeach
				</tbody>
			</table>
