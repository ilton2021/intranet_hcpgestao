@extends('layouts.adm')
	...
	<div class="row" style="margin-top: 0px;">
		<div class="col-md-12 text-center">
			<h3 style="font-size: 18px;">EXCLUIR PROTOCOLOS INSTITUCIONAIS:</h3>
		</div>
	</div>
	@if ($errors->any())
		 ...
		 <div class="accordion" id="accordionExample">
                <div class="card">
                    <a class="card-header bg-success text-decoration-none text-white bg-success" type="button" data-toggle="collapse" data-target="#PESSOAL" aria-expanded="true" aria-controls="PESSOAL">
                        Excluir Protocolos Institucionais: <i class="fas fa-check-circle"></i>
                    </a>
                </div>	
					<form action="{{\Request::route('destroyProtocolos')}}" method="post">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<table border="0" class="table table-sm" style="line-height: 1.5;" >
						 <tr>
							<td> Nome: </td>
							<td>
								<input class="form-control form-control-sm" type="text" id="nome" name="nome" readonly value="<?php echo $protocolos[0]->nome; ?>" />
							</td>
						 </tr>
						 <tr>
							<td> Sigla: </td>
							<td>
								<input class="form-control form-control-sm" type="text" id="sigla" name="sigla" readonly value="<?php echo $protocolos[0]->sigla; ?>" />
							</td>
						 </tr>
						 <tr>
							<td> Imagem: </td>
							<td> 
							  <input class="form-control form-control-sm" type="text" id="imagem" name="imagem" readonly value="<?php echo $protocolos[0]->imagem; ?>" /> 
                   		    </td>
						 </tr>
                         <tr>
