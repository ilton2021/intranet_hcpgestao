...
<div class="container-fluid">
	<div class="row" style="margin-bottom: 25px; margin-top: 25px;">
		<div class="col-md-12 text-center">
			<h5  style="font-size: 18px;"><b>CADASTRO DE PROTOCOLOS INSTITUCIONAIS:</b></h5>
		</div>
	</div>	
	@if ($errors->any())
	...
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12">
			...
			<form action="{{ route('pesquisarProtocolos') }}" method="post">
				...
				<tr>
					...
					<td>
					  <p align="right">
						...
						<a class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('protocolosNovo')}}"> Novo <i class="fas fa-check"></i> </a>
					  </p>
					</td>
				</tr>
			</table>
			...
			<table>
			 <tr>
			  <td> {{ $protocolos->appends(['pesq' => isset($pesq) ? $pesq : '','pesq2' => isset($pesq2) ? $pesq2 : ''])->links() }} </td>
			 </tr> 
		 	</table>
		</div>
	</div> 
