  ...
  <meta charset="UTF-8">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Elemento', 'Total'],
          ['0% - <?php echo $perg13a ?>',   <?php echo $perg13a ?>],
          ['1-25% - <?php echo $perg13b ?>',   <?php echo $perg13b ?>],
          ['26-50% - <?php echo $perg13c ?>',   <?php echo $perg13c ?>],
          ['51-75% - <?php echo $perg13d ?>',   <?php echo $perg13d ?>],
          ['> 76% - <?php echo $perg13e ?>',   <?php echo $perg13e ?>]
        ]);
        var options = {
          title: 'Saúde:',
          width: 400,
  ...
  <div class="container text-center" style="margin-left: -70px;">
      ...
      <div class="row">
        <table class="table table-bordeared table-striped">
         <form action="{{ route('pesqSobreVoce3') }}" method="post">
		     <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <tr>
            <td colspan="3"><b>(Sobre Você) Atualmente com qual situações abaixo você mais se preocupa?</b></td>
          </tr>
          <tr>
            <td>Departamento:</td>
            <td>
          ...
          <tr>
            <td colspan="3">
              <center>
                <a href="{{ route('graphicsSobreVoce') }}" id="Voltar" name="Voltar" type="button" class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> VOLTAR <i class="fas fa-undo-alt"></i> </a> 
              </center>
            </td>
          </tr>
         </form>
