    ...
    <br>
      <div class="row">
       <table class="table table-bordeared table-striped">
        <form action="{{ route('pesqOndeTrabalha3') }}" method="post">
		    <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <tr>
          <td colspan="3"><b>(Onde Trabalha) Qual o seu Grau de Satisfação em relação ao seu trabalho no HSS?</center></b></td>
        </tr>
        <tr>
          <td>Departamento:</td>
          <td>
