    ...
    <br>
      <div class="row">
       <table class="table table-bordeared table-striped">
        <form action="{{ route('pesqOndeTrabalha') }}" method="post">
		    <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <tr>
          <td colspan="3"><b>(Onde Trabalha) Como você classifica seu grau de confiança para expor suas ideias dentro da Empresa?</b></td>
        </tr>
        <tr>
          <td>Departamento:</td>
          <td>
        ...
        <tr>
          <td colspan="3"><br><div id="donutchart"></div></td>
        </tr>
        <tr>
