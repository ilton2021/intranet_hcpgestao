    ...
    <br>
      <div class="row">
       <table class="table table-bordeared table-striped">
        <form action="{{ route('pesqOndeTrabalha2') }}" method="post">
		    <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <tr>
          <td colspan="3"><b>(Onde Trabalha) Quanto as condições Físicas e Ambientais do seu Local de Trabalho:</b></td>
        </tr>
        <tr>
          <td>Departamento:</td>
          <td>
