...
<div class="container-fluid">
	<div class="row" style="margin-top: 0px;">
		<div class="col-md-12 text-center">
			<h3 style="font-size: 18px;">EXCLUIR VÍNCULO - INDICADORES / PERFIL USUÁRIO:</h3>
		</div>
	</div>
	@if ($errors->any())
	...
	<div class="row" style="margin-top: 25px;">
		...
		<div class="col-md-8 col-sm-12 text-center">
			<div class="accordion" id="accordionExample">
				...
				<?php $indicador_id = $Indicadores[0]->id ?>
				<form action="{{route('destroyIndUser', array($indicador_id,$Indi_pfUser[0]->id_perfil))}}" method="post">
						...
						<thead class="bg-info">
							<tr>
								...
								<td style="width: 500px;">
									<center><b>USUÁRIO</b></center>
								</td>
							</tr>
						</thead>
						@foreach($Indi_pfUser as $iPfuser)
						<tr>
							<td>
								<center>{{ $iPfuser->indicador }}</center>
							</td>
							<td>
								<center>{{ $iPfuser->perfil }} </center>
							</td>
						</tr>
						@endforeach
					</table>
					<tr>
						<td><input hidden type="text" id="tela" name="tela" class="form-control" value="excluir_PFUsuario_Indicadores" /></td>
