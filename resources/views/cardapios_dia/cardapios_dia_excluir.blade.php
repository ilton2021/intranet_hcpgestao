...
@extends('layouts.adm')
	...
	<div class="row" style="margin-top: 0px;">
		<div class="col-md-12 text-center">
			<h3 style="font-size: 18px;">EXCLUIR CARDÁPIO DO DIA:</h3>
		</div>
	</div>
	@if ($errors->any())
		 ...
		 <div class="accordion" id="accordionExample">
            <div class="card">
             <a class="card-header bg-success text-decoration-none text-white bg-success" type="button" data-toggle="collapse" data-target="#PESSOAL" aria-expanded="true" aria-controls="PESSOAL">
                Excluir Cardápio do Dia: <i class="fas fa-check-circle"></i>
             </a>
            </div>	
			<br>
			 <form action="{{route('destroyCardapiosDia', array($id, $cardapiosDia[0]->id))}}" method="post">
			  <input type="hidden" name="_token" value="{{ csrf_token() }}">
			   <div class="form-row align-items-center">
				...
				<div class="col-md-4 mb-3">
				 <b>TIPO REFEIÇÃO:</b>
				 <select readonly class="form-control" id="tipo_refeicao" name="tipo_refeicao" required>
				   @if($id == 1)
			 ...
			 <div class="form-row align-items-center">
			  ...
			  <div class="col-md-4 mb-3">
				<b>CAFÉ:</b>
			 	 <select readonly class="form-control" id="insumos_1_id" name="insumos_1_id" required>
			  ...
			  <div class="col-md-4 mb-3">
				<b>REFRESCO:</b>
			 	 <select readonly class="form-control" id="insumos_2_id" name="insumos_2_id" required>
			  	   <option value="" selected>Selecione...</option>
					@foreach($insumos as $insumo) 
			  ...
			  <div class="col-md-4 mb-3">
				<b>FRUTAS:</b>
			 	 <select readonly class="form-control" id="insumos_3_id" name="insumos_3_id" required>
			  	   <option value="" selected>Selecione...</option>
					@foreach($insumos as $insumo) 
			 ...
			 <div class="col-md-4 mb-3">
			    <b>COMIDA:</b> 
			 	 <select readonly class="form-control" id="insumos_4_id" name="insumos_4_id">
				   <option value="" selected>Selecione...</option>
					@foreach($insumos as $insumo) 
			  ...
			  <div class="col-md-4 mb-3">
				<b>MISTURA:</b> 
				 <select readonly class="form-control" id="insumos_5_id" name="insumos_5_id">
				   <option value="" selected>Selecione...</option>
					@foreach($insumos as $insumo)
			 ...
			 <div class="col-md-4 mb-3">
			  ...
			  <div class="col-md-4 mb-3">
				<b>MACARRÃO:</b> 
			  	 <select readonly class="form-control" id="insumos_6_id" name="insumos_6_id">
				  <option value="" selected>Selecione...</option>
				 	@foreach($insumos as $insumo) 
			 ...
			 <div class="col-md-4 mb-3">
			    <b>FAROFA:</b> 
				 <select readonly class="form-control" id="insumos_7_id" name="insumos_7_id">
				   <option value="" selected>Selecione...</option>
					@foreach($insumos as $insumo) 
			  ...
			  <div class="col-md-4 mb-3">
				<b>REFRESCO:</b> 
			 	 <select readonly class="form-control" id="insumos_8_id" name="insumos_8_id">
			  	   <option value="" selected>Selecione...</option>
					@foreach($insumos as $insumo) 
					 @if($insumo->nomeTipo == "REFRESCO")
			  ...
			  <div class="col-md-4 mb-3">
		  	    <b>SALADA:</b> 
				 <select readonly class="form-control" id="insumos_9_id" name="insumos_9_id">
				  <option value="" selected>Selecione...</option>
					@foreach($insumos as $insumo) 
			 ...
			 <div class="col-md-4 mb-3">
				<b>SOBREMESA:</b> 
				 <select readonly class="form-control" id="insumos_10_id" name="insumos_10_id">
				  <option value="" selected>Selecione...</option>
					@foreach($insumos as $insumo)
			 ...
			 <table>
			  <tr>
			    <td><input hidden type="text" id="tela" name="tela" class="form-control" value="excluir_cardapio_dia" /></td>
